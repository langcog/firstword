...
df_cdm$agesplit <- cut(df_cdm$age, breaks=c(0,12,24)) #there is a better way to do this, I just don't know what it is :(
```
...
qplot(prop, cdi_cat, col=agesplit,
      facets= . ~ dataset,
      data=freqs) +
